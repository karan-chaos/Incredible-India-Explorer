...
describe('Chet Singh Ghat Interactive Explorer', () => {
    ...
    beforeEach(() => {
        const dom = new JSDOM(`
            <!DOCTYPE html>
            <html lang="en">
            <body class="chet-singh-ghat-page">
                <div class="tabs-header">
                    <button class="tab-btn active" data-tab="tab-history">Historical Background</button>
                    <button class="tab-btn" data-tab="tab-king">Raja Chet Singh</button>
                    <button class="tab-btn" data-tab="tab-architecture">Fortified Architecture</button>
                    <button class="tab-btn" data-tab="tab-politics">1781 Rebellion</button>
                ...
                <div class="tab-content" id="tab-king">Raja Chet Singh content</div>
                <div class="tab-content" id="tab-architecture">Architecture content</div>
                <div class="tab-content" id="tab-politics">Politics content</div>
                <div class="tab-content" id="tab-timeline">Timeline content</div>

                <div class="quiz-container">
                    <div class="quiz-question">In which year did the rebellion take place at Chet Singh Ghat?</div>
                    <div class="quiz-options">
                        <button class="quiz-opt-btn" data-correct="false">1757 CE</button>
                        <button class="quiz-opt-btn" data-correct="true">1781 CE</button>
                    </div>
    ...
    it('switches active tabs correctly for Chet Singh Ghat', () => {
        ...
        expect(doc.getElementById('tab-king').classList.contains('active')).toBe(false);
        ...
        expect(doc.getElementById('tab-king').classList.contains('active')).toBe(true);
    });

    it('correctly evaluates 1781 rebellion quiz question', () => {
        ...
        function handleQuizClick(btn) {
            ...
            if (isCorrect) {
                feedback.innerHTML = 'Correct! 1781 CE';
            }
        }
    ...
    it('toggles light-theme mode for Chet Singh Ghat page', () => {
        const body = doc.body;
